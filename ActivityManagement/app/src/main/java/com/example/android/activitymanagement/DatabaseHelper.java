...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_IND_CATEGORY_ID = "Sub_Ind_ID";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE_IND_CATEGORY + "(Sub_Ind_ID INTEGER PRIMARY KEY AUTOINCREMENT, Hours_Spent INTEGER, Total_Hours INTEGER, Task_List varchar(3), Num_Of_Tasks INTEGER, Sub_Category_ID INTEGER)");
    ...
    public boolean insertIndividualCategory (String hoursSpent, String totalHours, String tasklList, String numOfTasks, String subCatID){
